    ...
    <form id="form1" runat="server">
        ...
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" CellPadding="4" 
            ...
            <emptydatatemplate>
                ...
                <tr>
                    <td>
                        <asp:TextBox ID="footerVcCommentBy" runat="server" />
                    </td>
                    <td>
                        <asp:TextBox ID="footerVcComment" runat="server" />
                    </td>
                     <td>
                        <asp:TextBox ID="footerIdClaim" runat="server" />
                    </td>
                    <td>
                        <asp:TextBox ID="footerVcClient" runat="server" />
                    </td>
                     <td>
                        <asp:TextBox ID="footerVcRefNo" runat="server" Text="(Optional)" />
                    </td>
                    <td>
                        <asp:TextBox ID="footerDatFollowUp" runat="server" Text="(Optional)" />
                    </td>
                    <td>
                        <asp:TextBox ID="footerVcNotes" runat="server" Text="(Optional)" />
                    </td>
                    <td>
                        <asp:Button ID="btnAdd" runat="server" Text="Add New" OnClick="InsertButton_Click"  />
                    </td>
                </tr>
